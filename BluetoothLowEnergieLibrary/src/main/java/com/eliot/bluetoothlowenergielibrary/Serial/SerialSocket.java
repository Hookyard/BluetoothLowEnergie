...
public class SerialSocket extends BluetoothGattCallback {
    ...
    private static final UUID BLUETOOTH_LE_TIO_CHAR_RX_CREDITS  = UUID.fromString("00000004-0000-1000-8000-008025000000"); // I2
    ...
    void disconnect() {
        ...
        if(delegate != null)
            delegate.disconnect();
        if (gatt != null) {
            System.out.println("//// c moi qui deco");
    ...
    private void onPairingBroadcastReceive(Context context, Intent intent) {
        ...
        switch (intent.getAction()) {
            case BluetoothDevice.ACTION_PAIRING_REQUEST:
                ...
                onSerialConnectError(new IOException("test"));
