...
public class SerialService extends Service implements SerialListener {
    ...
    public void onDestroy() {
        cancelNotification();
        disconnect();
        System.out.println("//// disconnectService");
        super.onDestroy();
    }
    ...
    private void createNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, Constants.NOTIFICATION_CHANNEL)
                ...
                .setOngoing(true)
                .addAction(new NotificationCompat.Action(/*R.drawable.ic_baseline_close_24*/1, "Disconnect", disconnectPendingIntent));
                ...
                if (listener != null) {
                    mainLooper.post(() -> {
                        if (listener != null) {
                            ...
                            cancelNotification();
                            disconnect();
                            System.out.println("disconnect3");
                        }
                    });
                } else {
                    ...
                    cancelNotification();
                    disconnect();
                    System.out.println("disconnect4");
                }
            }
        }
    }
